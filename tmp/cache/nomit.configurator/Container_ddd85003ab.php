...
class Container_ddd85003ab extends nomit\DependencyInjection\Container
{
	...
	protected array $wiring = [
		...
		'nomit\Kernel\Model\AbstractInteractiveModel' => [
			['model.5', 'model.6', 'model.7', 'model.8', 'model.12', 'model.13', 'model.14'],
		],
		'nomit\Kernel\Model\InteractiveModelInterface' => [
			['model.5', 'model.6', 'model.7', 'model.8', 'model.12', 'model.13', 'model.14'],
		],
		'Application\Model\Documentation\DocumentationModel' => [['model.5']],
		'Application\Model\Documentation\Tag\TagModel' => [['model.6']],
		'Application\Model\Documentation\Tag\DocumentationTagModel' => [['model.7']],
		...
		'Application\Controller\Documentation\DocumentationController' => [
			2 => ['controller.3', 'controller.4', 'controller.11', 'controller.13'],
		],
		'Application\Controller\Documentation\TagController' => [2 => ['controller.4', 'controller.13']],
		...
		'Application\Controller\Administration\AdministrationController' => [
			2 => ['controller.9', 'controller.10', 'controller.12'],
		],
		...
		'Application\Controller\Administration\DocumentationController' => [2 => ['controller.11']],
		'Application\Controller\Administration\AuthorizationController' => [2 => ['controller.12']],
		'Application\Controller\Administration\TagController' => [2 => ['controller.13']],
		...
		'nomit\Web\Request\RequestMatcherInterface' => [
			[
				...
				'authorization.request_matcher.uYtGoiU',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'env' => [
				...
				'SSH_AUTH_SOCK' => '/private/tmp/com.apple.launchd.MxxKhnDll6/Listeners',
				'__CF_USER_TEXT_ENCODING' => '0x1F5:0x0:0x52',
				'PATH' => '/usr/bin:/bin:/usr/sbin:/sbin',
				'__CFBundleIdentifier' => 'de.appsolute.MAMP',
				'PWD' => '/',
				'XPC_FLAGS' => '0x0',
				'XPC_SERVICE_NAME' => '0',
				'HOME' => '/Users/im.nomit',
	...
	public function createServiceAuthorization__access_map(): nomit\Security\Authorization\AccessMap
	{
		...
		$service->add($this->getService('authorization.request_matcher.uYtGoiU'), ['IS_AUTHENTICATED_FULLY'], false);
	...
	public function createServiceAuthorization__request_matcher__uYtGoiU(): nomit\Web\Request\RequestMatcher
	{
		return new nomit\Web\Request\RequestMatcher('^/api/articles', null, ['GET', 'POST']);
	}
	...
	public function createServiceContainer(): Container_ddd85003ab
	{
		return $this;
	}
	...
	public function createServiceController__11(): Application\Controller\Administration\DocumentationController
	{
	...
	public function createServiceController__12(): Application\Controller\Administration\AuthorizationController
	{
	...
	public function createServiceController__13(): Application\Controller\Administration\TagController
	{
	...
	public function createServiceModel__5(): Application\Model\Documentation\DocumentationModel
	{
		$service = new Application\Model\Documentation\DocumentationModel(
			$this->getService('database.default.connection'),
			$this->getService('database.default.explorer'),
			$this->getService('filesystem.filesystem'),
			$this->getService('cache.cache.application.application.model'),
	...
	public function createServiceModel__6(): Application\Model\Documentation\Tag\TagModel
	{
	...
	public function createServiceModel__7(): Application\Model\Documentation\Tag\DocumentationTagModel
	{
		$service = new Application\Model\Documentation\Tag\DocumentationTagModel(
			$this->getService('database.default.connection'),
			$this->getService('database.default.explorer'),
			$this->getService('cache.cache.application.application.model'),
		);
	...
	public function createServiceTemplate__kernelTemplateFactory(): nomit\Template\Bridges\Kernel\KernelTemplateFactory
	{
		return new class ($this) implements nomit\Template\Bridges\Kernel\KernelTemplateFactory {
			...
			public function __construct(Container_ddd85003ab $container)
			{
	...
	public function initialize()
	{
		...
		(function () {
			...
			$response = $this->getService('web.response');
			$response->headers->set('X-Powered-By', 'nomit');
