...
class Container_be3a4ef007 extends nomit\DependencyInjection\Container
{
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'env' => [
				...
				'LaunchInstanceID' => '0D729EF5-A741-491B-92F9-1125EEF1D4B4',
	...
	public function createServiceContainer(): Container_be3a4ef007
	{
		return $this;
	}
	...
	public function createServiceTemplate__kernelTemplateFactory(): nomit\Template\Bridges\Kernel\KernelTemplateFactory
	{
		return new class ($this) implements nomit\Template\Bridges\Kernel\KernelTemplateFactory {
			...
			public function __construct(Container_be3a4ef007 $container)
			{
