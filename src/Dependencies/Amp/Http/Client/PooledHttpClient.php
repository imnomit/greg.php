...
use Dependencies\Amp\Http\Client\Connection\ConnectionPool;
use Dependencies\Amp\Http\Client\Connection\InterceptedStream;
use Dependencies\Amp\Http\Client\Connection\Stream;
use Dependencies\Amp\Http\Client\Connection\UnlimitedConnectionPool;
