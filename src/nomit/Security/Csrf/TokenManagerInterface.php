...
namespace nomit\Security\Csrf;

use nomit\Security\Csrf\Token\TokenInterface;
use nomit\Security\Csrf\Token;
...
interface TokenManagerInterface
{
     ...
     *                        for the ID
     *
     * @return TokenInterface The CSRF token
     */
    public function getToken(string $tokenId): TokenInterface;
     ...
     * @return TokenInterface The CSRF token
     */
    public function refreshToken(string $tokenId): TokenInterface;
     ...
     */
    public function isTokenValid(TokenInterface $token);
