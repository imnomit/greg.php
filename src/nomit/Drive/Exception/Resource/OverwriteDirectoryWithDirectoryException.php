...
class OverwriteDirectoryWithDirectoryException extends DirectoryOperationException
{
    ...
    )
    {
        parent::__construct(
            ...
            sprintf('An error occurred while attempting to overwrite the destination directory, pathname "%s", with the source directory, pathname "%s".', $this->destinationPathname->getPathname(), $this->sourcePathname->getPathname()),
            $previous
        );
    }
