...
use nomit\Database\Exception\RuntimeException;
 ...
 */
class ResultSet implements \Iterator, RowContainerInterface
{
	...
	public function rewind(): void
	{
		if ($this->lastRow === false) {
			throw new InvalidStateException(self::class . ' implements only one way iterator.');
		}
	}
	...
	public function fetch(): ?Row
	{
		...
		if ($data === null) {
			...
			$duplicates = Utilities::findDuplicates($this->result);
	...
	{
		return Utilities::toPairs($this->fetchAll(), $key, $value);
	}
