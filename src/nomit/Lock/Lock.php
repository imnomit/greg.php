...
use nomit\Lock\Exception\LockAcquiringException;
use nomit\Lock\Exception\LockConflictedException;
use nomit\Lock\Exception\LockExpiredException;
use nomit\Lock\Exception\LockReleasingException;
