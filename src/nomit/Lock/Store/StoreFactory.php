...
use RedisArray;
use RedisCluster;
use nomit\Lock\Exception\InvalidArgumentException;
use nomit\Lock\PersistingStoreInterface;
use nomit\Cache\Adapter\AbstractAdapter;
use nomit\Cache\Traits\RedisClusterProxy;
use nomit\Cache\Traits\RedisProxy;
use TypeError;
use Zookeeper;
...
{
    /**
     * @param Redis|RedisArray|RedisCluster|ClientInterface|RedisProxy|RedisClusterProxy|Memcached|Collection|PDO|Connection|Zookeeper|string $connection Connection or DSN or Store short name
     *
    ...
    public static function createStore($connection)
    {
        ...
        switch (true) {
            ...
            case $connection instanceof Collection:
