...
namespace nomit\Template\Sandbox;
 ...
 * Default-deny policy.
 */
class SecurityPolicy implements \nomit\Template\Policy
{
	...
	public static function createSafePolicy(): self
	{
		...
		$policy->allowMethods(\nomit\Template\Essential\CachingIterator::class, self::All);
		$policy->allowProperties(\nomit\Template\Essential\CachingIterator::class, self::All);
