...
class Profile implements ProfileInterface
{
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Image\ProfileInterface::name()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Image\ProfileInterface::data()
     */
     ...
     * @param string $path
     *
     * @throws \nomit\Image\Exception\InvalidArgumentException In case the provided path is not valid
     *
     * @return static
     */
