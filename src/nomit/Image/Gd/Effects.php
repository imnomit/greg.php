...
namespace nomit\Image\Gd;

use nomit\Image\Driver\InfoProvider;
use nomit\Image\Effects\EffectsInterface;
...
use nomit\Image\Image\Palette\Color\RGB as RGBColor;
use nomit\Image\Utils\Matrix;
...
class Effects implements EffectsInterface, InfoProvider
{
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::gamma()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::negative()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::grayscale()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::colorize()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::sharpen()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::blur()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::brightness()
     */
     ...
     * {@inheritdoc}
     *
     * @see \nomit\Image\Effects\EffectsInterface::convolve()
     */
