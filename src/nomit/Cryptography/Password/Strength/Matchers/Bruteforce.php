...
namespace nomit\Cryptography\Password\Strength\Matchers;

use nomit\Cryptography\Password\Strength\Scorer;

/**
 * Class Bruteforce
 * @package nomit\Cryptography\Password\Strength\Matchers
 *
