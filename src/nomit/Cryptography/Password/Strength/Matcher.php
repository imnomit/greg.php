...
namespace nomit\Cryptography\Password\Strength;

use nomit\Cryptography\Password\Strength\Matchers\BaseMatch;
use nomit\Cryptography\Password\Strength\Matchers\MatchInterface;
...
class Matcher
{
     ...
     *
     * @see  PasswordStrength/src/matching.coffee::omnimatch
     */
